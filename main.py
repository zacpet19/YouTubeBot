...
def main():
    ...
    TextToSpeech.makeAudioFileSameLength("audio/4.mp3", "audio/changedVol.mp3")
    print("random background music created")
    TextToSpeech.mergeAudioFiles(["audio/4.mp3", "audio/modMusic.mp3"])
    ...
    VideoMethods.resizeImageForYouTubeShort("images/4.png")
    print("Image resized")
    ...
    thisDict = {"Title" : "Reddit Test Video 3", "Description" : "Still testing"}
